              ...
              <ul class="sui-nav">
                ...
                <li :class="{ active: isOne }" @click="changeOrder('1')">
                  <a href="#">综合<span v-show="isOne" class="iconfont"
                      :class="{ 'icon-down': isAsc, 'icon-Up-': isDesc }"></span></a>
                </li>
            ...
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="good in goodsList" :key="good.id">
                <div class="list-wrap">
                  ...
                  <div class="operate">
                    <router-link class="sui-btn btn-bordered btn-danger" to="/addcartsuccess">加入购物车</router-link>
...
export default {
  ...
  methods: {
    ...
    removeCategoryName() {
      ...
      // 要把对应的分类级别也清空，因为不确定是几级，都清空
      this.getData(); //还需再次发起请求
      // 地址栏也需要修改,自己跳转自己，要注意严谨，不该删除的不要删
    ...
    attrInfo(attr, attrValue) {
      ...
      // 保证数组中不能有重复数据，不然一直点击一直有重复面包屑，数组去重
